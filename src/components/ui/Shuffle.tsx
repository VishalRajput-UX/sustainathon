      ...
      const play = () => {
        ...
        const tl = gsap.timeline({
          ...
          onRepeat: () => {
            ...
            if (isVertical) {
              gsap.set(strips, { y: (_: any, t: any) => parseFloat(t.getAttribute('data-start-y') || '0') });
            } else {
              gsap.set(strips, { x: (_: any, t: any) => parseFloat(t.getAttribute('data-start-x') || '0') });
            }
            onShuffleComplete?.();
          },
          onComplete: () => {
        ...
        const addTween = (targets: any[], at: number) => {
          ...
          if (isVertical) {
            vars.y = (_: any, t: any) => parseFloat(t.getAttribute('data-final-y') || '0');
          } else {
            vars.x = (_: any, t: any) => parseFloat(t.getAttribute('data-final-x') || '0');
          }
